...
data class Daily (var dt:Int? = null, var sunrise:Int? = null, var sunset:Int? = null,
                  var moonrise:Int? = null, var moonset:Int? = null,
                  @SerializedName("moon_phase" )var moonPhase:Double? = null,var temp:Temp? = Temp(),
                  ...
                  var clouds:Int? = null, var pop:Double? = null,
                  var rain:Double? = null, var uvi:Double? = null
)